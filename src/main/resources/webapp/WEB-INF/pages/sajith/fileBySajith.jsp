						...
						<div class="card card-hgt common-tablediv">
							<div class="rcard-body">
								<div class="table-rounded">
								    <table id="FileSentTable" class="display">
								        <thead>
								            <tr>
												<th></th>
												<th>Comp No.</th>
...
$(document).ready(function () {
    ...
    var table = $('#FileSentTable').DataTable({
        processing: true,
        serverSide: true,
		...
		columns: [
		            ...
		            { data: 'computerNumber', defaultContent: '' },
		            {
		                ...
		                render: function (data) {
							...
							// File No.
					    { data: 'subject', defaultContent: '' },        // Subject
					    { data: 'senderName', defaultContent: '' },     // Sent To
					    { data: 'sentOn', defaultContent: '' },         // Sent On
					    { data: 'currentlyWith', defaultContent: '' },  // Currently With
					    { data: 'dueOn', defaultContent: '' },          // Due On
					    {
					        data: null,
							defaultContent: '',
					        orderable: false,
					        searchable: false,
					       /* render: function (data) {
					            return '<button class="btn btn-sm btn-primary action-btn" data-id="' + data + '">Action</button>';
					        }*/
					    }
		        ]
    });
